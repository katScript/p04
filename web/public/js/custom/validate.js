...
jQ(window).on('load', function() {
    jQ(".form-valide").validate({
        ignore: [],
        errorClass: "invalid-feedback animated fadeInDown",
        errorElement: "div",
        errorPlacement: function (e, a) {
            jQ(a).parents(".form-group > div").append(e)
        },
        highlight: function (e) {
            jQ(e).closest(".form-group").removeClass("is-invalid").addClass("is-invalid")
        },
        success: function (e) {
            jQ(e).closest(".form-group").removeClass("is-invalid");
            jQ(e).remove();
        },
        rules: {
